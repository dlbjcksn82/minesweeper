...
Further Ideas:
Beyond the scope of the assignment.  I added the ability for the game to automatically flag mines once the AI identifies them.
I would also like to come back to this and give the random move selection some intelligence.  This could be like starting from a corner or choosing moves near a space that has a lower probability of containing a mine. 
