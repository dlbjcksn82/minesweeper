...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        #        4) mark any additional cells as safe or as mines
        #       if it can be concluded based on the AI's knowledge base
        print("Checking for safes and mines")
        for sentence in self.knowledge:
            safes = sentence.known_safes()
            if safes:
                print("Found Safe Spots")
                for pos in safes.copy():
                    self.mark_safe(pos)
                self.knowledge.remove(sentence)
            mines = sentence.known_mines()
            if mines:
                print("Found Mines")
                for pos in mines.copy():
                    self.mark_mine(pos)
        ...
        print("Showing current Knowledge")
        for sentence in self.knowledge:
            print(sentence)
        print("Remaining Safe Moves")
    ...
    def make_random_move(self):
        ...
        """
        print("Running make random move code")
